...
public Reimbursement(int reim_id, int emp_id, int grade_id, int evt_id, int reimTotAmount, 
		int reimAmtApproved, String reimStatus, String dateSub, 
...
public Reimbursement(int emp_id, int grade_id, int reimTotAmount, int reimAmtApproved, String reimStatus,
